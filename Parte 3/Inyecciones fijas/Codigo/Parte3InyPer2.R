...
simular_resultado <- function(u, c, Tmax = 120, nsim = 250,
  ...
  for (i in 1:nsim) {
    ...
    arribos_brutos_iny <- seq(0, Tmax, by = 1 / 0.3)
...
write.csv(rejilla, file = "C:/Users/DiDi/Documents/JIM/Tesis/Simulaciones/Parte 3/Inyecciones fijas/Outputs/P3_Rej_InyPer.csv", row.names = FALSE)
