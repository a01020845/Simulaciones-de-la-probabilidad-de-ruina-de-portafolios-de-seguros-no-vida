...
simular_resultado <- function(u, c, Tmax = 120, nsim = 250,
  ...
  for (i in 1:nsim) {
    ...
    inyecciones <- rpareto(n_iny, location = xm, shape = alpha)
...
write.csv(rejilla, file = "C:/Users/DiDi/Documents/JIM/Tesis/Simulaciones/Parte 3/Pareto/Outputs/P3_Rej_Par.csv", row.names = FALSE)
