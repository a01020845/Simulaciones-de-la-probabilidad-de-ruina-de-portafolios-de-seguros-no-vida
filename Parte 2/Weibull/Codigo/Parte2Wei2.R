...
simular_resultado <- function(u, c, Tmax = 120, nsim = 250,
  ...
  for (i in 1:nsim) {
    ...
    arribos_brutos_sin <- cumsum(rweibull(n = Tmax * 2 / sigma, 
                                          shape = k, scale = sigma))
...
write.csv(rejilla, file = "C:/Users/DiDi/Documents/JIM/Tesis/Simulaciones/Parte 2/Weibull/Outputs/P2_Rej_Wei.csv", row.names = FALSE)
