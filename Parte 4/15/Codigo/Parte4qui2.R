...
simular_resultado <- function(u, c, Tmax = 180, nsim = 250,
...
write.csv(rejilla, file = "C:/Users/DiDi/Documents/JIM/Tesis/Simulaciones/Parte 4/15/Outputs/P4_Rej_15.csv", row.names = FALSE)
