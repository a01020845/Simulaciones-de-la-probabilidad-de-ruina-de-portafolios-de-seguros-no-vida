...
simular_resultado <- function(u, c, Tmax = 60, nsim = 250,
...
write.csv(rejilla, file = "C:/Users/DiDi/Documents/JIM/Tesis/Simulaciones/Parte 4/5/Outputs/P4_Rej_5.csv", row.names = FALSE)
